...
export const useTelegramStore = defineStore('telegram', () => {
  ...
  const isFromTelegram = ref(false)
  ...
  const userName = computed(() => {
    ...
    return user.value.username || `${user.value.first_name}${user.value.last_name ? ' ' + user.value.last_name : ''}`
  })
